...
public class KiteAuthDetails {
	...
	public void onCreate() {
		this.createdDate = LocalDateTime.now(ZoneId.of("Asia/Kolkata")).format(DateTimeFormatter.ofPattern("dd-MM-yyyy HH:mm:ss"));
	    this.authDate = LocalDate.now(ZoneId.of("Asia/Kolkata"));
	}    
}